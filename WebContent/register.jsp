...
<head>
    ...
    <style>
        ...
        .unameDiv, .pwdDiv, .repwdDiv,.uphoneDiv{
            width: 250px;
            height: 60px;
            text-align: left;
            color: red;
    ...
    <script type="text/javascript">
        ...
        function checkUphone(){
        	...
        	if(uphone==""){
        		 $(".uphoneDiv").html("用户手机号不能为空");
        		 return flag;
        	}else if(uphone.length!=11||isNaN(uphone)){
        		
        		$(".uphoneDiv").html("用户手机号不正确");
        		return flag;
        	}else{
        		 $.ajax({
                     async:false,//设置为同步请求
                     ...
                     success:function(result){
                    	 if($.trim(result)=="false"){
         					$(".uphoneDiv").html("用户手机号可以使用");
         					flag=true;
         				}else if($.trim(result)=="true"){
         					$(".uphoneDiv").html("用户手机号已注册");
         					flag=false;
         				}
                     },
                     error:function(){
...
<body>
<!--注册表单-->
<form method="post" action="AddUserServlet" class="registerForm">
    <!-- 注册主页面-->
    ...
    <div class="registerDiv">
        ...
        <div class="registerLeftBox">
            ...
            <div class="registerLeft">用户电话</div>
            <div class="TipregisterLeft">更多信息</div>
            <div class="registerLeft">公司名称</div>
            <div class="registerLeft">公司联系地址</div>
            <div class="registerLeft">公司电话</div>
            <div class="registerLeft">公司网址</div>
            ...
            <div class="registerMid">
             ...
             <div class="registerMid">
                <input id="uphone" name="uphone" type="text"
                       placeholder="请输入你的手机号" onblur="checkUphone()"><span
                    class="mustWrite">*</span>
            </div>
            <div class="registerMid">选填</div>
            <div class="registerMid">
